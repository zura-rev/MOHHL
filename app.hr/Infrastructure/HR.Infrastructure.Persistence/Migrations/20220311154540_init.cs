        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Structures_Positions_PositionId",
                        column: x => x.PositionId,
                        principalTable: "Positions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Structures_Sections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RealSalary = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_Structures_StructureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_StructureId",
                table: "Orders",
                column: "StructureId");

            migrationBuilder.CreateIndex(
                name: "IX_Structures_PositionId",
                table: "Structures",
                column: "PositionId");

            migrationBuilder.CreateIndex(
                name: "IX_Structures_SectionId",
                table: "Structures",
                column: "SectionId");
        }
